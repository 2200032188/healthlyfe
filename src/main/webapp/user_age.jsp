...
<body>
    ...
    <main>
        ...
        <section class="options-section">
            ...
            <div class="option-card">
                ...
                <div class="option-info">
                    <h3>4-12 Years</h3>
                    <button class="icon-btn" onclick="window.location.href='user_children.jsp';">Select</button>
                </div>
            </div>
            ...
            <div class="option-card">
                ...
                <div class="option-info">
                    <h3>12-20 Years</h3>
                    <button class="icon-btn" onclick="window.location.href='user_body_12_20.jsp';">Select</button>
                </div>
            </div>
            ...
            <div class="option-card">
                ...
                <div class="option-info">
                    <h3>20-45 Years</h3>
                    <button class="icon-btn" onclick="window.location.href='user_body_20_45.jsp';">Select</button>
                </div>
            </div>
            ...
            <div class="option-card">
                ...
                <div class="option-info">
                    <h3>45-100 Years</h3>
                    <button class="icon-btn" onclick="window.location.href='user_body_45_100.jsp';">Select</button>
                </div>
            </div>
        </section>
        ...
        <div class="nav-buttons">
            <button class="back-btn" onclick="window.location.href='userhome.jsp';">Back</button>
        </div>
    </main>
