...
<body>
    ...
    <div class="button-container">
        <!-- Submit Button -->
        <button type="button" onclick="window.location.href='first.html';">Main Page</button>

        <!-- Back Button -->
        <button type="button" class="back-btn" onclick="window.location.href='my_food_age_selection.html';">Back</button>
    </div>
