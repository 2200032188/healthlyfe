...
<body>
    ...
    <div class="button-container">
        <!-- Submit Button -->
        <button type="button" onclick="window.location.href='userhome.jsp';">Main Page</button>

        <!-- Back Button -->
        <button type="button" class="back-btn" onclick="window.location.href='my_health_status.jsp';">Back</button>
    </div>
