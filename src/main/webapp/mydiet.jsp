...
<body>
    ...
    <div class="container">
        ...
        <div class="triangle-container">
            <!-- My Food Button -->
            <button class="select-btn my-food" onclick="window.location.href='my_food_age_selection.jsp';">My Food</button>

            <!-- Timers Button -->
            <button class="select-btn timers" onclick="window.location.href='mytimers.jsp';">Timers</button>

            <!-- My Health Status Button -->
            <button class="select-btn health-status" onclick="window.location.href='my_health_status.jsp';">My Health Status</button>
        </div>
