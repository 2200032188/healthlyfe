...
<body>
    ...
    <main class="main-section">
        ...
        <div class="data-display" id="boys-data">
            ...
            <div class="body-type">
                ...
                <div>
                    ...
                    <button class="select-btn" onclick="window.location.href='12_male_ectomorph.jsp';">Select</button>
                </div>
            </div>
            <div class="body-type">
                ...
                <div>
                    ...
                    <button class="select-btn" onclick="window.location.href='12_male_mesomorph.jsp';">Select</button>
                </div>
            </div>
            <div class="body-type">
                ...
                <div>
                    ...
                    <button class="select-btn" onclick="window.location.href='12_male_endomorphic.jsp';">Select</button>
                </div>
            </div>
        </div>
        ...
        <div class="data-display" id="girls-data">
            ...
            <div class="body-type">
                ...
                <div>
                    ...
                    <button class="select-btn" onclick="window.location.href='12_girls_rectangle.jsp';">Select</button>
                </div>
            </div>
            <div class="body-type">
                ...
                <div>
                    ...
                    <button class="select-btn" onclick="window.location.href='12_girls_inverted_triangle.jsp';">Select</button>
                </div>
            </div>
            <div class="body-type">
                ...
                <div>
                    ...
                    <button class="select-btn" onclick="window.location.href='12_girls_hourglass.jsp';">Select</button>
                </div>
            </div>
            <div class="body-type">
                ...
                <div>
                    ...
                    <button class="select-btn" onclick="window.location.href='12_girls_round.jsp';">Select</button>
                </div>
            </div>
            <div class="body-type">
                ...
                <div>
                    ...
                    <button class="select-btn" onclick="window.location.href='12_girls_athletics.jsp';">Select</button>
                </div>
            </div>
        </div>
        ...
        <div class="nav-buttons">
            <button class="back-btn" onclick="window.location.href='user_age.jsp';">Back</button>
            <button class="submit-btn" onclick="window.location.href='userhome.jsp';">Main Page</button>
        </div>
